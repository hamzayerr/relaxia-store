...
export interface Product {
  ...
  type: 'capsule' | 'cream' | 'serum'
  volume?: string
  capsules?: number
  category: 'digestive' | 'joints' | 'nails'
  images: {
    hero: string
    gallery: string[]
  }
...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    nameAr: 'كيرانكس',
    nameFr: 'KERANEX',
    taglineAr: 'أظافر قوية وصحية — مع كيرانكس',
    subTaglineAr: 'سيروم متطور لتقوية الأظافر الهشة والمتقصفة، غني بالبيوتين والكيراتين وزيت الأركان لنمو وحماية الأظافر من الجذور حتى الأطراف.',
    descriptionAr: 'سيروم علاج الأظافر المتطور يهدف إلى تقوية وتحسين صحة الأظافر، مع التركيز على ترميم الأظافر الهشة والمتقصفة. يحتوي على تركيبة غنية بالفيتامينات والمعادن الأساسية مثل البيوتين والكيراتين، التي تساهم في تعزيز نمو الأظافر وتحسين مظهرها. بفضل خصائصه المغذية، يعمل على تقوية الأظافر من الجذور حتى الأطراف، مما يجعلها أكثر مرونة وأقل عرضة للتكسر.',
    type: 'serum',
    volume: '10ml',
    category: 'nails',
    images: {
    ...
    benefits: [
      'يقوي الأظافر ويحسن من مرونتها',
      'يعزز نمو الأظافر ويحسن من قوتها',
      'يمنح الأظافر مظهرًا صحيًا ولمعانًا طبيعيًا',
      'يعمل على ترطيب الأظافر والجلد المحيط بها بعمق',
    ],
    howToUse: [
      'ضع قطرات من السيروم على الأظافر والجلد المحيط بها',
      'دلك بلطف حتى يتم الامتصاص بالكامل — يُستخدم مرتين يوميًا',
    ],
    warnings: [
      'يُمنع استخدامه للأشخاص الذين يعانون من حساسية تجاه الزيوت الطبيعية',
      'لا يُستخدم على جروح مفتوحة أو التهابات',
    ],
    crossSells: ['melanex', 'flexima'],
    rating: 4.8,
    reviewCount: 512,
    problemHeading: 'أظافرك هشة وكتتكسر بسهولة؟',
    problemBody: 'أظافر هشة وسهلة التكسر، نمو بطيء، وجلد جاف حول الأظافر — مشاكل كتأثر على ثقتك وعلى مظهر يديك كل يوم.\n\nجربتي مناكير وكريمات مختلفة، لكن النتيجة كانت مؤقتة والأظافر رجعت تتكسر من جديد.\n\nهاد المشكل ما خاصو يبقى جزء من يومك — والحل كيبدأ بتغذية حقيقية من الجذور.',
    solutionHeading: 'كيرانكس — سيروم مغذي يقوي الأظافر من الجذور',
    solutionBody: 'الأظافر القوية محتاجة تغذية عميقة — مو غير طلاء يغطي السطح.\nكيرانكس صُمم بتركيبة غنية بالبيوتين، الكيراتين، وزيت الأركان الخالص — تعمل سويًا على تقوية الأظافر من الجذور حتى الأطراف.',
    resultsTimeline: [
      { week: 'الأسبوع الأول', result: 'ترطيب فوري للأظافر والجلد المحيط بها' },
      { week: 'الأسبوع الثالث', result: 'تقليل ملحوظ في تكسر وتقصف الأظافر' },
      { week: 'الشهر الأول', result: 'أظافر أقوى وأكثر لمعانًا' },
    ],
    testimonials: [
      { name: 'سعاد ل.', city: 'الرباط', text: 'أظافري كانت تتكسر بسهولة، بعد 3 أسابيع مع كيرانكس صارت أقوى بكثير ولامعة. منتج رائع!', rating: 5 },
      { name: 'إيمان ز.', city: 'الدار البيضاء', text: 'سهل الاستخدام وريحته زوينة. حسيت بفرق في ترطيب الجلد حول الأظافر من أول أسبوع.', rating: 5 },
      { name: 'خديجة ن.', city: 'مراكش', text: 'كنت كنخبي يدي بسبب الأظافر المتقصفة. دابا نقدر نلاقي حتى بلا مناكير. شكرًا كيرانكس!', rating: 5 },
    ],
    faq: [
      { q: 'كم من الوقت قبل ما نشوف نتيجة؟', a: 'الترطيب يبان من أول استخدام. التقوية الحقيقية للأظافر تبدا تبان بعد 3-4 أسابيع من الاستخدام المنتظم.' },
      { q: 'واش يمكن نستخدمو مع المناكير؟', a: 'نعم، يُفضل استخدامه على أظافر نظيفة بلا مناكير، أو مساءً قبل النوم بعد إزالة المناكير.' },
      { q: 'كم مرة نستخدمو في اليوم؟', a: 'مرتين يوميًا — صباحًا ومساءً، على الأظافر والجلد المحيط بها.' },
      { q: 'واش الضمان حقيقي؟', a: 'نعم. 30 يوم كاملين — إلا ما عجبكش، نردو ليك فلوسك بلا أسئلة.' },
      { q: 'الدفع كيكون فاش؟', a: 'الدفع عند الاستلام — كتدفع فقط مللي تستلم طلبيتك.' },
    ],
  },
