...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    problemBody: 'البهاق ما مرض — هو فقدان طبيعي للميلانين في بعض المناطق من الجلد.\nوالنتيجة: بقع بيضاء، تفاوت في لون البشرة، وشعور بعدم الراحة.\n\nالكريمات العادية كتغطي فقط — ما كتعالجش السبب.\nوالعلاجات القاسية كتجي بآثار جانبية وتهيجات.\n\nالحل: تحفيز الميلانين من الداخل — بمكونات طبيعية مثبتة علميًا.',
    solutionHeading: 'ميلانكس — تحفيز الميلانين بطريقة طبيعية وآمنة',
    solutionBody: 'ميلانكس صُممت بتركيبة دقيقة تجمع بين فيتامين B12، النياسيناميد، ومستخلص الخلة (المعروف منذ القدم في علاج البهاق). كلها بنسب آمنة ومدروسة لتحفيز إنتاج الميلانين بشكل طبيعي.',
    resultsTimeline: [
