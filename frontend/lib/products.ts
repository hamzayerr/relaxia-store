...
export const PRODUCTS: Product[] = [
  {
    ...
    subTaglineAr: 'بروبيوتيك + ألياف الأكاسيا + صبار الألوفيرا — فورمولا علمية دقيقة',
  ...
  },
  {
    ...
    subTaglineAr: '6 مكونات طبيعية مثبتة علميًا ضد الجرثومة — مو مضادات حيوية قاسية',
    ...
    testimonials: [
      ...
      { name: 'أسماء ك.', city: 'طنجة', text: 'توصية صادقة: إلا عندك أعراض جرثومة المعدة — جرب بيلوريكس. ما خسرتيش شي مع الضمان.', rating: 5 },
    ],
    faq: [
      ...
      { q: 'الدفع كيكون فاش؟', a: 'الدفع عند الاستلام — ما خسرتيش شي.' },
    ],
  },
  {
    id: 'flexima',
    ...
    subTaglineAr: 'جلوكوزامين + MSM + أرنيكا — الثلاثي الذهبي لصحة المفاصل',
