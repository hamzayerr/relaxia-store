...
const DATA: Record<string, {
  ...
  coloflora: {
    ...
    pairs: [
      ...
      {
        problem: '«جربت أدوية من الصيدلية — ساعدت أسبوع وبعدها رجع كل شي.»',
        solution: 'كولوفلورا ما كتعالجش الأعراض — كتصلح السبب الحقيقي: اختلال التوازن الهضمي.',
      },
      {
        problem: '«الإمساك والإسهال بالتداول، ومحتاشين علاش — خيفت من حاجة خطيرة.»',
        solution: 'ألياف الأكاسيا كتنظم حركة الأمعاء بطريقة طبيعية — بدون تهييج أو اعتماد.',
      },
    ],
  },
}
